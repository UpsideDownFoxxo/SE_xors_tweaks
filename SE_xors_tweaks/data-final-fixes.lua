...
if settings.startup["xor-enable-900-steam"].value == true then
	...
	table.insert(
		...
		{ type = "unlock-recipe", recipe = data_util_SE.mod_prefix .. "electric-boiling-steam-900" }
	)
end
...
if settings.startup["xor-enable-415-steam"].value == true then
	...
	table.insert(
		data.raw["technology"]["se-electric-boiler"].effects,
		{ type = "unlock-recipe", recipe = data_util_SE.mod_prefix .. "electric-boiling-steam-415" }
	)
end

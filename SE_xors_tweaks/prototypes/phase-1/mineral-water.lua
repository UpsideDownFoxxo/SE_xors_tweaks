...
data:extend({
	{
		...
		icons = {
			...
			{
				icon = data.raw.fluid["kr-mineral-water"].icon,
				icon_size = data.raw.fluid["kr-mineral-water"].icon_size,
				scale = 0.33 * 64 / (data.raw.fluid["kr-mineral-water"].icon_size or 64),
				shift = { 5, 5 },
			},
		},
		ingredients = {
